...
import static test.tesuto.Utility.Initialization.getDriver;
...
public class AllureCucumber3Jvm implements Formatter {
    ...
    private Status translateTestCaseStatus(Result testCaseResult) {
        switch(testCaseResult.getStatus()) {
            case FAILED:
                lifecycle.addAttachment("Screenshot",(String)null, (String)null, ((TakesScreenshot) getDriver()).getScreenshotAs(OutputType.BYTES));
